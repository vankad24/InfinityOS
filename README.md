...
## Требования
- Возможность запускать linux программы, android приложения и, как минимум, частичную поддержку windows программ. Возможно, посредством симуляции окружения этих ОС.
