...
- При печати текста появляются подсказки. На android подсказки есть, что очень удобно. Поэтому, почему бы их не сделать на компьютере? Причём с настройками словаря и автодополнения.
