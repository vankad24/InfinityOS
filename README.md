...
- В свойствах ярлыка или папки можно сменить иконку на свою. Для этого можно воспользоваться стандартная утилитой и сгенерировать ico файл из png. Либо можно вообще поставить галочку "Без иконки", чтобы сделать невидимую папку.
Реестр?
...
- В стандартных программах есть программа для записи и запуска макросов.
