...
- Возможность использовать беспродное устройство как дополнительный экран. Причем, если, например, телевизор не поддерживает chromecast, то на него можно установить специальное приложение.  
